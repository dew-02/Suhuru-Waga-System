            ...
            >
                ...
                <div className="features-grids">
                    <div className="feature-card">
                        ...
                        <p className="card-text">Land management involves overseeing the use and development of land resources, and the "Lands" feature provides a platform for users to list, buy, or sell agricultural land.</p>
                    </div>
